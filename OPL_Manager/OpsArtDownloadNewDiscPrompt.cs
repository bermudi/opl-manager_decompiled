...
public class OpsArtDownloadNewDiscPrompt : BaseForm
{
	...
	public OpsArtDownloadNewDiscPrompt()
	{
		InitializeComponent();
	}
	...
	private void Button1_Click(object sender, EventArgs e)
	{
		...
		try
		{
			opsArtDownloadReport.ShowDialog(GAME, ArtType.ICO, new List<string> { url }, 0);
		}
		finally
		{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(OpsArtDownloadNewDiscPrompt));
		B_YES = new Button();
		B_NO = new Button();
		...
		((Control)B_YES).Location = new Point(12, 93);
		...
		((Control)B_NO).Location = new Point(77, 93);
		...
		((Control)PictureBox1).Location = new Point(38, 12);
		((Control)PictureBox1).Name = "PictureBox1";
		((Control)PictureBox1).Size = new Size(64, 64);
		PictureBox1.SizeMode = (PictureBoxSizeMode)4;
		PictureBox1.TabIndex = 1;
		PictureBox1.TabStop = false;
		((Control)Button1).Location = new Point(12, 149);
		((Control)Button1).Name = "Button1";
		((Control)Button1).Size = new Size(115, 27);
		((Control)Button1).TabIndex = 22;
		((Control)Button1).Text = "Report Disc";
		...
		((Form)this).ClientSize = new Size(134, 182);
		...
		((Control)this).MinimumSize = new Size(150, 220);
		((Control)this).Name = "OpsArtDownloadNewDiscPrompt";
		((Form)this).ShowInTaskbar = false;
		((Form)this).StartPosition = (FormStartPosition)4;
		((Control)this).Text = "Choose Disc";
