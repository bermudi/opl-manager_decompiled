...
public class OpsArtDownloadNewBackPrompt : BaseForm
{
	...
	public OpsArtDownloadNewBackPrompt()
	{
		InitializeComponent();
	}
	...
	private void Button1_Click(object sender, EventArgs e)
	{
		...
		try
		{
			opsArtDownloadReport.ShowDialog(GAME, ArtType.COV2, new List<string> { url }, 0);
		}
		finally
		{
	...
	private void InitializeComponent()
	{
		...
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(OpsArtDownloadNewBackPrompt));
		B_YES = new Button();
		B_NO = new Button();
		...
		((Control)B_YES).Location = new Point(62, 362);
		...
		((Control)B_NO).Location = new Point(150, 362);
		...
		((Control)PictureBox1).Size = new Size(242, 344);
		PictureBox1.SizeMode = (PictureBoxSizeMode)4;
		PictureBox1.TabIndex = 1;
		PictureBox1.TabStop = false;
		((Control)Button1).Location = new Point(62, 418);
		((Control)Button1).Name = "Button1";
		((Control)Button1).Size = new Size(138, 27);
		((Control)Button1).TabIndex = 20;
		((Control)Button1).Text = "Report Back Cover";
		...
		((Form)this).ClientSize = new Size(265, 452);
		...
		((Control)this).MinimumSize = new Size(270, 490);
		((Control)this).Name = "OpsArtDownloadNewBackPrompt";
		((Form)this).ShowInTaskbar = false;
		((Form)this).StartPosition = (FormStartPosition)4;
		((Control)this).Text = "Choose Back";
